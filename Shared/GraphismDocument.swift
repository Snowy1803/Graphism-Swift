    ...
    init(shapes: [GShape]? = nil) {
        if let shapes = shapes {
            ...
            self.shapes = [GRectangle(position: Pos(x: 200, y: 100), size: Pos(x: 150, y: 100), paint: .color(.wrapping(.red))),
                           GRectangle(position: Pos(x: 40, y: 0), size: Pos(x: 50, y: 100), paint: .color(.wrapping(.green)), strokeStyle: StrokeWrapper(strokeWidth: 5, strokeType: .rounded, strokeDashArray: GRPHArray([1, 10], of: SimpleType.float))),
                           ...
                           GLine(start: Pos(x: 275, y: 150), end: Pos(x: 110, y: 275), paint: .color(.wrapping(.black)), strokeStyle: StrokeWrapper(strokeType: .rounded)),
                           ...
                           GClip(shape: GRectangle(position: Pos(x: 300, y: 300), size: Pos(x: 50, y: 50), paint: .radial(.init(centerColor: .wrapping(.orange), externalColor: .wrapping(.red), radius: 25))),
